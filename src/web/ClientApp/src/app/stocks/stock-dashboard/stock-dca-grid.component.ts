...
@Component({
  selector: 'stock-dca-grid',
  templateUrl: './stock-dca-grid.component.html',
  styleUrls: ['./stock-dca-grid.component.css']
})
export class StockDCAGridComponent implements OnInit {
