...
The site allows to track stock, option, and crypto currency purchases. Storage is managed using PostgreSQL.
...
Uses PostgreSQL for storing all information including event sourced aggregates.
