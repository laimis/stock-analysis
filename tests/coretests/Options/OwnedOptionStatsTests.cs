...
namespace coretests.Options
{
    public class OwnedOptionStatsTests
    {
        ...
        public OwnedOptionStatsTests()
        {
            ...
            var soldOption1 = new OwnedOption(TestDataGenerator.AMD, 45, OptionType.CALL, new DateTimeOffset(2019, 10, 10, 0, 0, 0, TimeSpan.Zero), userId);
            ...
            var soldOption2 = new OwnedOption(TestDataGenerator.AMD, 45, OptionType.CALL, new DateTimeOffset(2019, 10, 10, 0, 0, 0, TimeSpan.Zero), userId);
